    ...
    <section className="container mx-auto mt-3 flex max-h-screen min-h-screen flex-col items-center justify-around px-5 md:px-1">
      ...
      <div className="z-50 flex flex-col items-center space-y-5 sm:space-y-10">
        ...
        >
          ...
          <Image src={mainImg} unoptimized alt="logo" className="w-52 object-contain lg:w-64" />
        ...
        <SocialLinks />
        <a
           href="/YashSadabal_Resume.pdf"
           download="YashSadabal_Resume.pdf"
           className=" inline-flex items-center justify-center rounded-full bg-primary-700 p-1.5 text-white shadow-lg transition-all duration-200 hover:bg-primary-600 dark:bg-primary-300 dark:text-gray-800 dark:hover:bg-primary-400"
           style={{
           fontSize: '1.25rem',
            marginTop: '0.25rem',
         }}
